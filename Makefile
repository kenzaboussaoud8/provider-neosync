...
PROJECT_NAME ?= provider-neosync
PROJECT_REPO ?= github.com/jellysmack/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE=nucleuscloud/neosync
export TERRAFORM_PROVIDER_REPO=https://github.com/nucleuscloud/terraform-provider-neosync
export TERRAFORM_PROVIDER_VERSION=0.2.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME=neosync
export TERRAFORM_NATIVE_PROVIDER_BINARY=terraform-provider-neosync_v0.2.1
...
xpkg.build.provider-neosync: do.build.images
